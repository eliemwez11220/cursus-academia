        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="font-weight-bold">Configuration - Grades Agents</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Grades agents</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h5 class="font-weight-bold text-uppercase">Liste &nbsp;  Grades agents</h5>
                            </div>
                                ...
                                <a data-toggle="modal" data-target="#nouvel_element"
                                   href="#" class="btn btn-info btn-xs  text-uppercase">
                                    <span data-toggle="tooltip" data-placement="top"
                                        ...
                                        <i class="fa fa-plus"></i> Nouveau &nbsp; Grade Agent
                                    </span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive-sm">
                                <table id="datatablesExample2"
                                    ...
                                    $status = (! empty(esc($value['grade_statut']))?esc($value['grade_statut']):'inactif');
                                    ?>
                                    <tr>
                                        <td><?= $count++; ?></td>
                                        <td><?= esc($value['grade_code']); ?></td>
                                        <td class="text-uppercase"><?= esc($value['grade_libelle']); ?></td>
                                        <td>
                                            <a href="<?= base_url('agent/changeStatus/grade/'.esc($status).'/'.esc($value['grade_uid'])); ?>"
                                        ...
                                        <td><?= esc($value['grade_created_at']); ?></td>
                                        <td width="1px" class="text-center">
                                            ...
                                            <td width="1px" class="text-center">
                                                <a href="<?= base_url('agent/details/grade/'.esc($value['grade_uid'])); ?>" class="btn btn-xs btn-outline-info">
                                                        <span data-toggle="tooltip" data-placement="top"
                                        ...
                                        <div class="modal fade" id="update_<?= $count; ?>">
                                            <div class="modal-dialog" role="document">
                                                ...
                                                Grade <?= (!empty(esc($value['grade_libelle']))) ? esc($value['grade_libelle']):'Aucun'; ?></h4>
                                                    ...
                                                    echo form_open('agent/saveGradeAgents/update/'.esc($value['grade_uid']), $attributes);
                                                    ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="code_grade" class="control-label">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           name="code_grade"
                                                                           id="code_grade"
                                                                           value="<?= (!empty(esc($value['grade_code']))) ? esc($value['grade_code']) :old('code_grade') ?>"
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="libelle_grade" class="control-label">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           name="libelle_grade"
                                                                           id="libelle_grade"
                                                                           value="<?= (!empty(esc($value['grade_libelle']))) ? esc($value['grade_libelle']) :old('libelle_grade') ?>"
                                                                           style="border-radius: 10px!important;"
                                                                           required/>
                                                                </div>
                                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Ajout d'un nouveau grade agents</h4>
            ...
            $attributes = array('role' => 'form', 'autocomplete' => 'off');
            echo form_open('agent/saveGradeAgents/create/', $attributes);
            ?>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="code_grade" class="control-label">
                                <span class="text-danger">*</span> Code Grade Agents
                                <span class="small">
                            ...
                            <input type="text"
                                   ...
                                   name="code_grade"
                                   id="code_grade"
                                   value="<?= (!empty($new_code_generate)) ? $new_code_generate : old('code_grade') ?>"
                                   style="border-radius: 10px!important;"
                                   required/>
                        </div>
                    </div>
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="libelle_grade" class="control-label">
                                <span class="text-danger">*</span> Libellé Grade Agents
                            </label>
                            <input type="text"
                                   class="form-control text-capitalize"
                                   name="libelle_grade"
                                   id="libelle_grade"
                                   value="<?= old('libelle_grade') ?>"
                                   style="border-radius: 10px!important;"
                                   required/>
                        </div>
                    </div>
