        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="font-weight-bold">Personnel - Nouvelle Attribution Tâche</h5>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                   ...
                   $validation = \Config\Services::validation();
                    ...
                    echo form_open(base_url() . '/agent/saveTache/create/', $attributes);
                    ?>
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools float-right">
                                <button type="submit" class="btn btn-info btn-rounded text-uppercase btn-xs">
                                    <i class="fa fa-check-circle"></i> Enregistrer la tâche
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select id="agent_tache" name="agent_tache"
                                                class="form-control select2 select2-info <?php if($validation->hasError( 'agent_tache')){echo 'is-invalid';} ?>"
                                            ...
                                            if (isset($agents) && !empty($agents)):
                                                foreach ($agents as $key => $value):
                                                    if (session()->get('agent_tache_attribution') == esc($value['agent_uid'])) { ?>
                                                        <option selected value="<?= esc($value['agent_uid']); ?>" <?= set_select('agent_tache', esc($value['agent_uid'])); ?>>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select id="type_tache" name="type_tache"
                                                class="form-control select2 select2-info <?php if($validation->hasError( 'type_tache')){echo 'is-invalid';} ?>"
                                                data-dropdown-css-class="select2-info">
                                ...
                                <div class="col-lg-8 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               class="form-control <?php if($validation->hasError( 'libelle_tache')){echo 'is-invalid';} ?>"
                                               name="libelle_tache" id="libelle_tache"
                                               value="<?= set_value('libelle_tache') ?>"
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <label for="code_tache" class="control-label">
                                            <span class="text-danger">*</span> Code Tache
                                            <span class="small"> (Ce code a été généré mais modifiable)</span>
                                        </label>
                                        <input type="text"
                                               class="form-control <?php if($validation->hasError( 'code_tache')){echo 'is-invalid';} ?>"
                                               name="code_tache"
                                               id="code_tache"
                                               value="<?= (!empty($new_code_generate)) ? $new_code_generate : set_value('code_tache') ?>"
                                               style="border-radius: 10px!important;"/>
                                        <?php if(isset($validation)): ?>
                                            <span class="invalid-feedback">
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="date_debut_annee"
                                            ...
                                            <?php if($validation->hasError( 'date_debut_tache')){echo 'is-invalid';} ?>"
                                                   name="date_debut_tache"
                                                   id="date_debut_annee" data-target="#date_debut_annee"
                                                   value="<?= set_value('date_debut_tache') ?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="date_fin_annee"
                                            ...
                                            <input type="text" name="date_fin_tache"
                                                   ...
                                                   <?php if($validation->hasError( 'date_fin_tache')){echo 'is-invalid';} ?>"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="compose-textarea"> <span class="text-danger">*</span> Description Execution Tâche</label>
                                        <textarea id="compose-textarea" name="description_tache" class="form-control" rows="10" style="height: 500px!important;"
                                                  placeholder="Decrivez l'execution de la tache ici..."><?= set_value('description_tache');?></textarea>
                                    </div>
