...
<div class="content-wrapper">
    ...
    <filiere class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="font-weight-bold text-capitalize">Administration - Comptes Administrateurs</h5>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                               <h5 class="font-weight-bold text-uppercase">Liste des comptes</h5>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive-sm">
                                <table id="datatablesExample2"
                                    ...
                                    $status = (! empty(esc($value['admin_statut']))?esc($value['admin_statut']):'inactif');
                                    ?>
                                    <tr>
                                        <td><?= $count++; ?></td>
                                        <td class="text-uppercase small">
                                            <?= esc($value['admin_fullname']); ?>
                                        </td>
                                        <td class="small"><?= esc($value['admin_pseudo']); ?></td>
                                        <td>
                                            <a href="<?= base_url('admin/changeStatus/admin/'.esc($status).'/'.esc($value['admin_uid'])); ?>"
                                        ...
                                        <td class="text-uppercase small"><?= esc($value['admin_profile']); ?></td>
                                        ...
                                        <td width="1px" class="text-center">
                                            <a href="<?= base_url('admin/details/admins/'.esc($value['admin_uid'])); ?>"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header text-center">
                                                    <h4 class="modal-title d-inline-flex">
                                                        <span class="text-uppercase small">
                                                            <?= esc($value['admin_fullname']); ?> - <?= esc($value['admin_pseudo']); ?>
                                                        </span>
                                                    </h4>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    echo form_open('admin/resetAdminPassword/' .esc($value['admin_uid']), $attributes);
                                                    ?>
                                                    <div class="row">
