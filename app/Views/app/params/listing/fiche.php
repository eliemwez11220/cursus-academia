            ...
            <div class="card">
                <div class="card-header">
                     ...
                     <div class="card-title">
                        <h5>FICHE D'IDENTIFICATION DE L'ECOLE</h5>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                <h5 class="font-weight-bold text-uppercase mt-3"> <?= (isset($ecole) ? esc($ecole['ecole_libelle']) : 'Information Ecole'); ?></h5>
                            </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table id="datatablesWithoutActions"
                                    ...
                                    <tr>
                                        ...
                                        <td><?= (isset($typesecole)) ? esc($typesecole['ecole_updated_at']) : 'Aucune date'; ?></td>
                                    </tr>
                                    <tr>
