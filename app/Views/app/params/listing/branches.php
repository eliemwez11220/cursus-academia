        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="font-weight-bold text-uppercase">Configuration - branche</h5>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h5 class="font-weight-bold text-uppercase">Liste &nbsp;  branches</h5>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive-sm">
                                <table id="datatablesExample2"
                                    ...
                                    $status = (! empty(esc($value['branche_statut']))?esc($value['branche_statut']):'inactif');
                                    ?>
                                    <tr>
                                        <td><?= $count++; ?></td>
                                        <td><?= esc($value['branche_code']); ?></td>
                                        <td class="text-uppercase"><?= ($value['branche_libelle']); ?></td>
                                        <td>
                                            <a href="<?= base_url('ecole/changeStatus/branche/'.esc($status).'/'.esc($value['branche_uid'])); ?>"
                                        ...
                                        <td><?= esc($value['branche_created_at']); ?></td>
                                            ...
                                            <td width="1px" class="text-center">
                                                <a href="<?= base_url('ecole/details/branche/'.esc($value['branche_uid'])); ?>" class="btn btn-xs btn-outline-info">
                                                        <span data-toggle="tooltip" data-placement="top"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header text-center">
                                                        ...
                                                        <h4 class="modal-title d-inline-flex">Modification
                                                            branche <?= esc($value['branche_libelle']); ?></h4>
                                                    ...
                                                    echo form_open('ecole/saveBranche/update/'.esc($value['branche_uid']), $attributes);
                                                    ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="code_branche" class="control-label">
                                                                        <span class="text-danger">*</span> Code branche
                                                                    </label>
                                                                    <input type="text"
                                                                           class="form-control bg-light text-capitalize"
                                                                           name="code_branche"
                                                                           id="code_branche"
                                                                           value="<?= (!empty(esc($value['branche_code']))) ? esc($value['branche_code']) : old('code_branche') ?>"
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="libelle_branche" class="control-label">
                                                                        <span class="text-danger">*</span> Nom ou Libellé branche
                                                                    </label>
                                                                    <input type="text"
                                                                           class="form-control"
                                                                           name="libelle_branche"
                                                                           id="libelle_branche"
                                                                           value="<?= (!empty(($value['branche_libelle']))) ? esc($value['branche_libelle']) : old('libelle_branche') ?>"
                                                                           style="border-radius: 10px!important;"
                                                                           required/>
                                                                </div>
                                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-uppercase">Ajout d'une nouvelle branche</h4>
            ...
            $new_code_generate = "CB" . substr(str_shuffle(str_repeat($aleatoire_value, mt_rand(5, 20))), 0, 5);

            $attributes = array('role' => 'form', 'autocomplete' => 'off');
            echo form_open('ecole/saveBranche/create', $attributes);
            ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   name="code_branche"
                                   id="code_branche"
                                   value="<?= (!empty($new_code_generate)) ? $new_code_generate : set_value('code_branche') ?>"
                                   style="border-radius: 10px!important;"
                                   required/>
                        </div>
                    </div>
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   name="libelle_branche"
                                   id="libelle_branche"
                                   value="<?= set_value('libelle_branche') ?>"
                                   style="border-radius: 10px!important;"
                                   required/>
                        </div>
                    </div>
