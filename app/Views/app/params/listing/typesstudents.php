        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="font-weight-bold">Configuration - Categorie Etudiants</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url('overview/type/dashboard') ?>">Accueil</a>
                                </li>
                                <li class="breadcrumb-item active">Categories Etudiants</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h5 class="font-weight-bold text-uppercase">Liste &nbsp;  Catégories</h5>
                            </div>
                                ...
                                <a data-toggle="modal" data-target="#nouvel_element"
                                   href="#" class="btn btn-info btn-xs  text-uppercase">
                                    <span data-toggle="tooltip" data-placement="top"
                                        ...
                                        <i class="fa fa-plus"></i> Nouvelle  &nbsp; Catégorie Etudiant
                                    </span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive-sm">
                                <table id="datatablesExample2"
                                    ...
                                    $status = (! empty(esc($value['typesetudiant_statut']))?esc($value['typesetudiant_statut']):'inactif');
                                    ?>
                                    <tr>
                                        <td><?= $count++; ?></td>
                                        <td><?= esc($value['typesetudiant_code']); ?></td>
                                        <td class="text-uppercase"><?= ($value['typesetudiant_libelle']); ?></td>
                                        <td>
                                            <a href="<?= base_url('ecole/changeStatus/typesetudiant/'.esc($status).'/'.esc($value['typesetudiant_uid'])); ?>"
                                        ...
                                        <td><?= esc($value['typesetudiant_created_at']); ?></td>
                                        ...
                                        <td width="1px" class="text-center">
                                            <a href="<?= base_url('ecole/details/typesetudiants/'.esc($value['typesetudiant_uid'])); ?>"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header text-center">
                                                        ...
                                                        <h4 class="modal-title d-inline-flex">Modification
                                                            catégorie étudiant <?= esc($value['typesetudiant_libelle']); ?></h4>
                                                    ...
                                                    echo form_open('ecole/saveCategorieetudiants/update/'.esc($value['typesetudiant_uid']), $attributes);
                                                    ?>
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="code_type_etudiant" class="control-label">
                                                                        <span class="text-danger">*</span> Code Catégorie
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           value="<?= (!empty(esc($value['typesetudiant_code']))) ? esc($value['typesetudiant_code']) :set_value('code_type_etudiant') ?>"
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="libelle_type_etudiant" class="control-label">
                                                                        <span class="text-danger">*</span> Libellé Catégorie Elèves
                                                                    </label>
                                                                    <input type="text"
                                                                           class="form-control text-capitalize"
                                                                           name="libelle_type_etudiant"
                                                                           id="libelle_type_etudiant"
                                                                           value="<?= (!empty(($value['typesetudiant_libelle']))) ? ($value['typesetudiant_libelle']) :set_value('libelle_type_etudiant') ?>"
                                                                           style="border-radius: 10px!important;"
                                                                           required/>
                                                                </div>
                                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Ajout d'une nouvelle catégorie d'Etudiant</h4>
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="libelle_type_etudiants" class="control-label">
                                <span class="text-danger">*</span> Libellé Catégorie
                            </label>
                            <input type="text"
                                   class="form-control text-capitalize"
                                   name="libelle_type_etudiant"
