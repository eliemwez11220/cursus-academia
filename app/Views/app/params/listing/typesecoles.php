        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <h5 class="font-weight-bold">Configuration - Types Ecoles</h5>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h5 class="font-weight-bold text-uppercase">Liste &nbsp; Types Ecoles</h5>
                            </div>
                            <div class="card-tools float-right">
                                <a data-toggle="modal" data-target="#nouvel_element"
                                   href="#" class="btn btn-info btn-xs  text-uppercase">
                                    <span data-toggle="tooltip" data-placement="top"
                                          title="Cliquer pour créer un nouveau type ecole">
                                        <i class="fa fa-plus"></i> Nouveau  &nbsp; Type Ecole
                                    </span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive-sm">
                                <table id="datatablesExample2"
                                    ...
                                    foreach ($typesecoles as $key => $value):
                                        $status = (! empty(esc($value['typesecole_statut']))?esc($value['typesecole_statut']):'inactif');
                                        ?>
                                        <tr>
                                            <td><?= $count++; ?></td>
                                            <td><?= esc($value['typesecole_code']); ?></td>
                                            <td class="text-uppercase"><?= ($value['typesecole_libelle']); ?></td>
                                            <td>
                                                <a href="<?= base_url('ecole/changeStatus/typesecole/'.esc($status).'/'.esc($value['typesecole_uid'])); ?>"
                                            ...
                                            <td><?= esc($value['typesecole_created_at']); ?></td>
                                            ...
                                            <td width="1px" class="text-center">
                                                <a href="<?= base_url('ecole/details/typesecoles/'.esc($value['typesecole_uid'])); ?>"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header text-center">
                                                        ...
                                                        <h4 class="modal-title d-inline-flex">Modification
                                                            type ecole <?= esc($value['typesecole_libelle']); ?></h4>
                                                    ...
                                                    echo form_open(base_url().'/ecole/saveTypeEcole/update/'.esc($value['typesecole_uid']), $attributes);
                                                    ?>
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           name="code_type_ecole"
                                                                           id="code_type_ecole"
                                                                           value="<?= (!empty(esc($value['typesecole_code']))) ? esc($value['typesecole_code']) : set_value('code_type_ecole') ?>"
                                                            ...
                                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <label for="libelle_type_ecole"
                                                                           class="control-label">
                                                                        <span class="text-danger">*</span> Libellé Type
                                                                        Ecole
                                                                    </label>
                                                                    <input type="text"
                                                                           class="form-control text-capitalize"
                                                                           name="libelle_type_ecole"
                                                                           id="libelle_type_ecole"
                                                                           value="<?= (!empty(($value['typesecole_libelle']))) ? ($value['typesecole_libelle']) :set_value('libelle_type_ecole') ?>"
                                                                           style="border-radius: 10px!important;"
                                                                           required/>
                                                                </div>
                                                            </div>
                                    ...
                                    <?php else: ?>
                                        <tr class="alert alert-info">
                                            <td colspan="8" class="text-uppercase">
                                                <strong>Aucun type ecole n'est enregistrée</strong>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                    </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Ajout d'un nouveau type d'école</h4>
            ...
            $validation = \Config\Services::validation();
            $attributes = array('role' => 'form', 'autocomplete' => 'off');
            echo form_open(base_url().'/ecole/saveTypeEcole/create/', $attributes);
            ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   name="code_type_ecole"
                                   id="code_type_ecole"
                                   value="<?= (!empty($new_code_generate)) ? $new_code_generate : set_value('code_type_ecole') ?>"
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label for="libelle_type_ecole" class="control-label">
                                <span class="text-danger">*</span> Libellé Type Ecole
                            </label>
                            <input type="text"
                                   class="form-control text-capitalize"
                                   name="libelle_type_ecole"
                                   id="libelle_type_ecole"
                                   value="<?= set_value('libelle_type_ecole') ?>"
                                   style="border-radius: 10px!important;" required/>
                        </div>
                    </div>
                </div>
