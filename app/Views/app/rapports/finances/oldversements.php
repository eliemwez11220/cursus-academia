                                            ...
                                            if (!empty($listVersements)):
                                                foreach ($listVersements as $key => $value):
                                                    ...
                                                    if ($value['payment_frais_uid'] == $ligne['typesfrai_uid']):
                                                        ...
                                                        ?>
                                                        <tr class="small"> 
                                                            <td class="text-uppercase" colspan="10"> 
                                                                <span class="font-weight-bold">  
                                                                <?= $count++; ?>.
                                                                  <?= ($ligne['typesfrai_libelle']); ?> -  
                                                                    Cycle (<?= ($ligne['cycle_libelle']); ?>) 
                                                                </span> 
                                                            </td> 
                                                        </tr>
                                                        <tr class="small">
                                                            ...
                                                            <td class="text-uppercase"><?= ($value['etudiant_nom']); ?>
                                                                <?= ($value['etudiant_postnom']); ?>
                                                                <?= ($value['etudiant_prenom']); ?>
                                                            </td>
                                                            
                                                            <td class="text-uppercase">
                                                                <?= ($value['promotion_libelle']); ?> 
                                                            </td>
                                ...
                                <table id="datatablesReportingActions"
                                    ...
                                    if (isset($mouvements) && !empty($mouvements)):
                                        foreach ($mouvements as $key => $value):
                                            ...
                                            $entree_cdf = (! empty($value['mouvement_montant'])) && (strtolower($value['mouvement_devise']) == "cdf") ?($value['mouvement_montant']) : 0;
                                            $entree_usd = (! empty($value['mouvement_montant'])) && (strtolower($value['mouvement_devise']) == "usd") ?($value['mouvement_montant']) : 0;
                                            
                                            $sorti_cdf = (($value['montant_sorti_cdf']));
                                            $sorti_usd = (($value['montant_sorti_usd']));
                                    ...
                                    ?>
                                        ...
                                        <tr class="text-uppercase">
                                        <td class="text-right"> Total SORTIE:</td>
                                        <td class="text-uppercase" >
                                                    <span class="font-weight-bold">
                                            ...
                                            <tr> <td class="text-uppercase text-right">Total Entrée:</td>
                                            <td class="text-uppercase" >
                                                    <span class="font-weight-bold">
                                            ...
                                            <tr> <td class="text-uppercase text-right">Total Fonctionnement:</td>
                                            <td class="text-uppercase" >
                                                    <span class="font-weight-bold">
