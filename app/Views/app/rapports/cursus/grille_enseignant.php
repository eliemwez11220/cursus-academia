                                            ...
                                            if (isset($etudiants) && !empty($etudiants)):
                                                foreach ($etudiants as $key => $etudiant):
                                                    ...
                                                    $totalgen = 0; 
                                                     ...
                                                     $total_echecs = 0;
                                                     $total = 0;
                                                     foreach ($matieres as $keym => $matierecote):
                                                        ...
                                                        <th class="text-center">
                                                            <?= (($matierecote['matiere_uid'] == $cote['cote_matiere_uid']) && $etudiant['etudiant_uid'] == $cote['cote_etudiant_uid']) ? ($cote_obtenue):0; ?> 
                                                        </th>
                                                        <th class="text-center"> 
                                                            <?= (($matierecote['matiere_uid'] == $cote['cote_matiere_uid']) && $etudiant['etudiant_uid'] == $cote['cote_etudiant_uid']) ? ($total):0; ?>  
                                                        </th>
