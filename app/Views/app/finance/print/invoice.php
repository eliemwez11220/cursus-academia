            ...
            <div class="row mb-2">
                <div class="col-sm-8">
                    ...
                    | <a href="<?= base_url('finance/addForm/paiement'); ?>"
                         class="btn btn-default btn-rounded text-uppercase btn-xs">
                        <i class="fa fa-arrow-circle-left"></i> Création
                    </a> |
                    <a href="javascript:void();" class="text-uppercase btn btn-success  btn-rounded btn-xs printoff"  onclick="printReport();">
