...
class PHPMailer
{
    ...
    public function preSend()
    {
        if ('smtp' == $this->Mailer or
            ('Visitor' == $this->Mailer and stripos(PHP_OS, 'WIN') === 0)
        ) {
    ...
    public function createHeader()
    {
        ...
        if ((
                'sendmail' == $this->Mailer or 'qmail' == $this->Mailer or 'Visitor' == $this->Mailer
            )
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                $file = tempnam(sys_get_temp_dir(), 'Visitor');
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        $lengthsub = 'Visitor' == $this->Mailer ? 13 : 0;
