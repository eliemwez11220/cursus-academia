...
class PHPExcel_Reader_HTML extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    protected $tabletudiantl = 0;
    protected $nestedColumn = array('A');

    protected function setTableStartColumn($column)
    {
        if ($this->tabletudiantl == 0) {
            $column = 'A';
        }
        ++$this->tabletudiantl;
        $this->nestedColumn[$this->tabletudiantl] = $column;

        return $this->nestedColumn[$this->tabletudiantl];
    }
...
//                        echo 'START OF TABLE LEVEL ' , $this->tabletudiantl , '<br />';
                        if ($this->tabletudiantl > 1) {
                            --$row;
                        }
                        $this->processDomElement($child, $sheet, $row, $column, $cellContent);
//                        echo 'END OF TABLE LEVEL ' , $this->tabletudiantl , '<br />';
                    ...
                    case 'tr':
                        ...
                        $cellContent = '';
//                        echo 'START OF TABLE ' , $this->tabletudiantl , ' ROW<br />';
                        $this->processDomElement($child, $sheet, $row, $column, $cellContent);
                        ++$row;
//                        echo 'END OF TABLE ' , $this->tabletudiantl , ' ROW<br />';
                        break;
                    case 'th':
                    case 'td':
//                        echo 'START OF TABLE ' , $this->tabletudiantl , ' CELL<br />';
                        $this->processDomElement($child, $sheet, $row, $column, $cellContent);
//                        echo 'END OF TABLE ' , $this->tabletudiantl , ' CELL<br />';
