...
class PHPExcel_IOFactory
{
    ...
    /**
     * Autoresolve promotions
     *
     * @var    array
     * @access    private
     * @static
     */
    private static $autoResolvepromotions = array(
        'Excel2007',
        'Excel5',
        'Excel2003XML',
        'OOCalc',
    ...
    public static function createReaderForFile($pFilename)
    {
        ...
        // Try walking through all the options in self::$autoResolvepromotions
        foreach (self::$autoResolvepromotions as $autoResolveClass) {
