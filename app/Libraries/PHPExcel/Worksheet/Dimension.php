...
abstract class PHPExcel_Worksheet_Dimension
{
     ...
     * @return int
     */
    public function getOutlinetudiantl()
    {
        return $this->outlinetudiantl;
    }
     ...
     * @return PHPExcel_Worksheet_Dimension
     */
    public function setOutlinetudiantl($pValue)
    {
        if ($pValue < 0 || $pValue > 7) {
            throw new PHPExcel_Exception("Outline level must range between 0 and 7.");
        }

        $this->outlinetudiantl = $pValue;
        return $this;
    }
